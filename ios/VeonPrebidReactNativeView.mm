#import "VeonPrebidReactNativeView.h"
...
@interface VeonPrebidReactNativeView () <RCTVeonPrebidReactNativeViewViewProtocol>

@end

@implementation VeonPrebidReactNativeView {
    UIView * _view;
}
...
{
    const auto &oldViewProps = *std::static_pointer_cast<VeonPrebidReactNativeViewProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<VeonPrebidReactNativeViewProps const>(props);
...
{
    return VeonPrebidReactNativeView.class;
}
